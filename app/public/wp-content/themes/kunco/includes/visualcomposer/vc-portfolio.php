...
class Kunco_Visualcomposer_Portfolio implements Vc_Vendor_Interface {
    ...
    $gva_portfolio_grid =  array(
      ...
      'params'      => array(
        ...
        array(
          ...
          'value'        => '',
          'description'  => esc_html__('Element only display custom categories & portfolio in custom categories', 'kunco')
        ),
        array(
          'type'         => 'textfield',
    ...
    add_filter( 'vc_autocomplete_gva_portfolio_slideset_ids_callback', array( $this, 'portfolioIdsAutocompleteSuggester') ); 
    add_filter( 'vc_autocomplete_gva_portfolio_slideset_ids_render', array(&$this, 'portfolioIdsAutocompleteRender' ) ); 
